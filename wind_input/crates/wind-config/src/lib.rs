...
pub use config::{
    ...
    CustomIdentity, CustomManifest, DEFAULT_DOTA2_ALIAS, DEFAULT_LABEL_CAPS, DEFAULT_LABEL_ENGLISH,
    DOTA2_ALIAS_MAX_LEN, KeyOrigin, LabelsConfig, LangBarConfig, LayerOrigin, LayoutIntent,
